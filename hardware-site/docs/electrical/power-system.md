...
| Power block | Each actuator, daisy-chained | 48 V | 18 AWG silicone **UNVERIFIED**{ .dh-unverified } | XT30(2+2), see [Harness fabrication](#harness-fabrication) |
...
| Upper-body power block | 48 V→12 V converter (E12, one per gripper) → servo driver board (E10) | 48 V → 12 V | 18 AWG silicone **UNVERIFIED**{ .dh-unverified } | Board screw terminals |
